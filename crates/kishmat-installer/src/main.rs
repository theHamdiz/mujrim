...
//! KishMat Installer — guided setup wizard.
...
// ──────────────────────────────────────────────────────────────
// Colors — matching kishmat-ui palette
// ──────────────────────────────────────────────────────────────
...
impl App {
    ...
    fn update(&mut self, msg: Msg) -> Task<Msg> {
        match msg {
            ...
            Msg::LaunchApp => {
                let exe = PathBuf::from(&self.install_dir).join("kishmat-ui");
    ...
    fn view_welcome(&self) -> Element<'_, Msg> {
        ...
        let heading = text("Welcome to KishMat").size(32).color(TEXT_PRIMARY);
    ...
    fn view_complete(&self) -> Element<'_, Msg> {
        ...
        let launch_btn = accent_btn("Launch KishMat").on_press(Msg::LaunchApp);
...
// ──────────────────────────────────────────────────────────────
// Styled buttons (matching kishmat-ui)
// ──────────────────────────────────────────────────────────────
