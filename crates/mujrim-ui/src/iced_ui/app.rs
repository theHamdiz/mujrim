...
pub(super) struct BundledEngineChoice {
    index: usize,
    label: String,
}
        ...
        match msg {
            ...
            Msg::BoardRightUp(row, col) => {
                    ...
                    && let Some(ref mut gs) = self.game
                {
                    ...
                    gs.finish_arrow(to, self.settings.arrow_color.into());
