...
#[derive(SystemParam)]
pub struct RenderModeParams<'w, 's> {
    keys: Res<'w, ButtonInput<KeyCode>>,
    render_dim: ResMut<'w, RenderDimension>,
    commands: Commands<'w, 's>,
    layout: Res<'w, BoardLayout>,
    game: Option<ResMut<'w, crate::state::ChessGame>>,
    board2d: Query<'w, 's, Entity, With<BoardEntity>>,
    pieces2d: Query<'w, 's, Entity, With<PieceSprite>>,
    camera2d: Query<'w, 's, Entity, With<Camera2d>>,
    board3d: Query<'w, 's, Entity, With<Board3dEntity>>,
    pieces3d: Query<'w, 's, Entity, With<Piece3d>>,
    board3d_assets: Res<'w, crate::board3d::Board3dAssets>,
}
...
pub fn toggle_render_mode(params: RenderModeParams<'_, '_>) {
    let RenderModeParams {
        keys,
        mut render_dim,
        mut commands,
        layout,
    ...
    match *render_dim {
        RenderDimension::TwoD => {
            ...
            crate::board3d::spawn_board_3d(commands.reborrow(), board3d_assets);
        ...
        RenderDimension::ThreeD => {
            ...
            for rank in 0..8u8 {
                for file in 0..8u8 {
                    ...
                    let flipped = game.as_ref().is_some_and(|g| g.flipped);
